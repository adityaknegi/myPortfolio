...
export default function Home(props) {
  return (
   <Section className={'py-12 h-70vh flex items-center bg-gray-50 bg-[#c476f11a] rounder-2xl'} bgColor={'bg-gray-100"'} id="aboutMe">
   <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <Heading type ={'h2'} className="text-3xl font-extrabold text-[#C476F1] sm:text-4xl">
            About Me
          </Heading>
